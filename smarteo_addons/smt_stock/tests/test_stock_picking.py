...
class TestStockPickingExportAction(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.picking = cls.env['stock.picking'].create({
            ...
            'location_id': picking_type.default_location_src_id.id or cls.env.ref('stock.stock_location_suppliers').id,
            'location_dest_id': picking_type.default_location_dest_id.id or cls.env.ref('stock.stock_location_stock').id,
        })
