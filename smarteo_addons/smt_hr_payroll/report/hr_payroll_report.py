...
class HrPayrollReport(models.Model):
    ...
    count_unforeseen_absence = fields.Integer(
        "Days of Unforeseen Absence", aggregator="sum", readonly=True
    )
    ...
    work_entry_source = fields.Selection(
        [("calendar", "Working Schedule"), ("attendance", "Attendances"), ("planning", "Planning")],
        readonly=True,
    )
    work_code = fields.Many2one("hr.work.entry.type", "Work type", readonly=True)
    work_type = fields.Selection(
        [("1", "Regular Working Day"), ("2", "Paid Time Off"), ("3", "Unpaid Time Off")],
